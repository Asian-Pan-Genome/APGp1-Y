...
regionNames = c("BLUE","TEAL","GREEN","RED","GRAY","YELLOW")

regionColor = c(rgb(202,232,250,max=255), # BLUE
                                rgb(169,214,209,max=255),  # TEAL
                                rgb(219,236,211,max=255),   # GREEN
                                rgb(251,213,206,max=255), # RED
                                rgb(232,227,224,max=255), # GRAY
                                rgb(255,252,210,max=255))   # YELLOW
