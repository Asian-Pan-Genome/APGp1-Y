...
perl cord_trans.pl ${sample}.${ampl}.bed ${color_bed}
Rscript dotplot.colors.r ${sample}.${ampl}.fasta.fai ${sample}.${ampl}.fasta.fai ${sample}.${ampl}.self_align.dat.mod ${color_bed}.cord_trans ${sample}.${ampl}.self_align.dotplot.color.pdf
