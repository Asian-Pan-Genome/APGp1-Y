...
df = fread("C001-CHA-E01.chrY.bed", stringsAsFactors = FALSE, fill=TRUE, quote="", header=FALSE, skip=2)
...
#print the table
write.table(het_df_filtered, "C001-CHA-E01.chrY.tbl", row.names = F, quote = F, sep="\t")
