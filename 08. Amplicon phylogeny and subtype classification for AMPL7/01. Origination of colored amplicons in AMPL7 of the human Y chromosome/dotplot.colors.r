...
regionNames = c("R1_1","R1_2","R2_1","R2_2","G_A","G1_1","G2_1","G2_2","B1_1","B1_2","B2_1","B2_2","GA_A","GA_1","GA_2","Y","T")

regionColor = c(rgb(234,153,153,max=255), #
                                rgb(224,102,102,max=255),  #
                                rgb(244,67,54,max=255),   # 
                                rgb(204,0,0,max=255), # 
                                rgb(181,230,162,max=255),
				rgb(142,217,115,max=255),# 
                                rgb(78,167,46,max=255),
 				rgb(60,125,34,max=255),  #
                                rgb(159,197,232,max=255),   # 
                                rgb(111,168,220,max=255), # 
                                rgb(61,133,198,max=255), # 
                                rgb(33,92,152,max=255),
				rgb(188,188,188,max=255),  #
                                rgb(153,153,153,max=255),   # 
                                rgb(91,91,91,max=255), # 
                                rgb(255,250,183,max=255), # 
                                rgb(169,214,209,max=255)
				)   # 
