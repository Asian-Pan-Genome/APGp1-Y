### Step1. Ancestral haplotype reconstruction of AMPL7
...
### Step2. Rearrangement inference of each haplotype against the ancestral haplotype of CT node (Hap6).
...
```
### Step3. Haplotype network based on rearrangements compared to reference (Hap6).
```
