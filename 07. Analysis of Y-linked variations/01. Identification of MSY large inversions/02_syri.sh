...
#rm ${qry_name}.delta
/share/home/zhanglab/user/nielei/miniconda3/envs/syri/bin/syri -c ${qry_name}.ragtag.i95_l1000.coords -d ${qry_name}.ragtag.i95_l1000.delta -r ${ref_name}.fa -q ${qry_name}.ragtag.fa --prefix ${qry_name}.ragtag
