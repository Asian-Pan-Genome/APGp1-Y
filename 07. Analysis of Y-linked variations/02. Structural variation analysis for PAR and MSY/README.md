...
```
python script/get_allele_per_pos_for_per_sample_from_vcf.py CHM13_PAR1.filter.SVs.merge.vcf CHM13_PAR1.filter.SVs.merge
...
python script/calculating_fst_from_vcf_bed.py CHM13_PAR1.filter.SVs.merge.vcf.bed PAR1.id.list CHM13_PAR1.filter.SVs.merge.vcf.bed
```
