...
Representative visualizations from both tools are shown in *Supplementary Fig1. S3*, with some other results available under [`/data/gavisunk/`](https://github.com/QYNi/APG-Y/edit/main/evaluation/data/gavisunk).
